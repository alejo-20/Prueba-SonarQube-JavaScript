...
export default function App() {
  ...
  function compute() {
    ...
    try {
      ...
      if (op === '%') r = A % B;
      setRes(r);
      // Corrección: Se cambió ${{variable}} por ${variable} para interpolación correcta en template strings
      const historyEntry = `${A}|${B}|${op}|${r}`;
      GLOBAL_HISTORY.push(historyEntry);
      console.log('History:', GLOBAL_HISTORY);
    } catch(e) {
